  ...
  const teamMembers = [
    {
      ...
      description: "Visionnaire et stratège, Mohamed dirige l'équipe avec passion et détermination."
    },
    {
      name: "Mohamed Houmed",
      role: "Comptable et Financier",
      photo: "/assets/houmed.jpg", 
      description: "Expert en gestion financière, Mohamed assure la solidité économique du projet."
    },
    {
      name: "Youssouf Abayazid",
      role: "Développeur Web",
      photo: "/assets/youssouf.jpg", 
      description: "Passionné de technologie, Youssouf donne vie à nos innovations numériques."
    }
  ];
